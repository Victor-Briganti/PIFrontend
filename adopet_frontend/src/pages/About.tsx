    ...
    <Main bgcolor="secondary.light" color="primary.contrastText">
      ...
      <Content>
        ...
        <MUI.Typography variant="h6" paragraph textAlign="left">
          ...
          país. Ao longo desses anos, temos testemunhado milhares de histórias
          de sucesso, onde esses animais encontraram um lugar onde podem
          descansar tranquilos, brincar livremente e receber todo o amor e
          carinho que merecem! =^.^=
        </MUI.Typography>
        <MUI.Typography variant="h4" gutterBottom textAlign="left">
          Como Funciona
        ...
        <MUI.Typography variant="h6" textAlign="justify">
          ...
          desejam doar um animal podem cadastrar-se gratuitamente em nosso site
          e imediatamente publicar detalhes sobre os animais, incluindo suas
          características e personalidade.
        </MUI.Typography>
        <br />
        <MUI.Typography variant="h6" textAlign="justify">
          Busca Personalizada: Aqueles que desejam adotar podem navegar pelo
          nosso site em busca de um animal que se encaixe em seu estilo de vida
          e preferências.
        </MUI.Typography>
        <br />
        <MUI.Typography variant="h6" textAlign="justify">
          Processo de Adoção: Quando encontrarem um animal especial, basta
          clicar em “quero adotar” e entrar em contato com a ONG para combinar
          os detalhes da adoção.
        </MUI.Typography>
        <br />
        <MUI.Typography variant="h6" paragraph textAlign="left">
